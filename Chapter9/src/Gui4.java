...
class Calc5 extends JFrame implements ActionListener
{
	JTextField jtf;
	String op1, op2;
	double result;
	...
	public Calc5()
	{
		...
		jp1.setBorder(new TitledBorder("계산결과 창"));
		...
		JButton jb12 = new JButton("1");
		JButton jb13 = new JButton("2");
		JButton jb14 = new JButton("3");
		JButton jb15 = new JButton("-");
		JButton jb16 = new JButton("1/x");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(s == "=")
		{
			...
			{
			case '+' :
				result = Double.parseDouble(op1) + Double.parseDouble(jtfs);
				jtf.setText(result + "");
			break;
			case '-' :
				result = Double.parseDouble(op1) - Double.parseDouble(jtfs);
